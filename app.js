...
function schoolTitleForClass(c){return ecde.includes(c)?"TINETKAPKOI ECDE SCHOOL":junior.includes(c)?"TINETKAPKOI JUNIOR SCHOOL":"TINETKAPKOI PRIMARY SCHOOL"}
function schoolTitleForSection(sec){return sec==="ECDE"?"TINETKAPKOI ECDE SCHOOL":sec==="Junior"?"TINETKAPKOI JUNIOR SCHOOL":"TINETKAPKOI PRIMARY SCHOOL"}
